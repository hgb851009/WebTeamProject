...
public class ActionFactory {
	...
	public Action action(String cmd) {
		if (cmd.equals("/shop.do")) {
			...
			action = new u_LoginAction("index.jsp");
		} else if (cmd.equals("/logout.do")) {
			action = new u_LogoutAction("index.jsp");
		} else if (cmd.equals("/signup.do")) {
			action = new SignUpAction("result/result.jsp");
		} else if (cmd.equals("/checkIdEmail.do")) {
			action = new CheckIdEmailAction("result/result.jsp");
		}
